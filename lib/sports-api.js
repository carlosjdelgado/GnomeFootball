...
// past/future days; the caller filters client-side by local date. Disk-first off
// the same fixtures/<slug>/scoreboard.json the poller reads, so the e2e runner
// can drive every day from one fixture. Only the network fallback uses the range.

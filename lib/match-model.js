...
// ESPN's `dates` param is UTC, while our day boundary is local; a match in the
// local early morning lands in ESPN's previous day. Fetch a UTC range spanning
// the local day ±1 (YYYYMMDD-YYYYMMDD) and filter by localDateKey afterwards.
export function utcRangeForLocalDay(date) {

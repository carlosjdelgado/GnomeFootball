...
export const COUNTRY_GROUPS = [
    ...
    },
    {
        ...
        defaultName: 'Mexico',
        leagues: [
            { slug: 'mex.1', defaultName: 'Liga MX' },
            { slug: 'mex.2', defaultName: 'Liga de Expansión MX' },
        ],
    },
    {
        id: 'colombia',
        ...
        leagues: [
            { slug: 'col.1',    defaultName: 'Categoría Primera A' },
            { slug: 'col.2',    defaultName: 'Categoría Primera B' },
            { slug: 'col.copa', defaultName: 'Copa Colombia' },
        ],
    },
    {
        id: 'chile',
        defaultName: 'Chile',
        leagues: [
            { slug: 'chi.1',        defaultName: 'Primera División' },
            { slug: 'chi.copa_chi', defaultName: 'Copa Chile' },
        ],
    },
    {
        id: 'usa',
...
// stream to the user). MATCH_REMINDER is also excluded: it needs its own lead-time
// spinner, so prefs renders it in a dedicated group rather than the plain switch list.

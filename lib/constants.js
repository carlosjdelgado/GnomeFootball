// Static catalog of ESPN soccer league slugs grouped by country / federation.
// Team rosters per league are discovered at runtime via the ESPN /teams endpoint
// and cached on disk; only the league slugs themselves live here.

export const ESPN_BASE_URL = 'https://site.api.espn.com/apis/site/v2/sports/soccer';

export const USER_AGENT = 'GnomeFootball/0.1 (+https://github.com/carlosjdelgado/gnomefootball)';
...
export const COUNTRY_GROUPS = [
    ...
    },
    {
        id: 'fifa',
        defaultName: 'FIFA',
        // World Cup is hidden in the UI unless the API returns active events.
        leagues: [
...
// Click target for notifications.
export function espnMatchUrl(eventId) {
